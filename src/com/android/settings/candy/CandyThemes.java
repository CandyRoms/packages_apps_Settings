...
import com.android.internal.util.candy.ThemesUtils;
import com.android.internal.util.candy.CandyUtils;
import com.android.settings.SettingsPreferenceFragment;
import net.margaritov.preference.colorpicker.ColorPickerPreference;

public class CandyThemes extends SettingsPreferenceFragment implements
    ...
    public void onCreate(Bundle icicle) {
        ...
        addPreferencesFromResource(R.xml.candy_themes);
    ...
    private void setupThemeSwitchPref() {
        ...
        if (CandyUtils.isThemeEnabled("com.android.theme.pitchblack.system")) {
            mThemeSwitch.setValue("6");
        } else if (CandyUtils.isThemeEnabled("com.android.theme.chocox.system")) {
            mThemeSwitch.setValue("5");
        } else if (CandyUtils.isThemeEnabled("com.android.theme.bakedgreen.system")) {
            mThemeSwitch.setValue("4");
        } else if (CandyUtils.isThemeEnabled("com.android.theme.solarizeddark.system")) {
